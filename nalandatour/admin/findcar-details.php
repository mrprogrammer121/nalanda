              ...
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?php echo $i++;?></td>
                      <td><?php echo $result['fromaddress'];?></td>
                      <td><?php echo $result['toaddress'];?></td>
                      ...
                      <td><a href="delete.php?id=<?php echo $result['id'];?>&type=bookcar" class="btn btn-danger"><i class="fa fa-trash"></i></a></td>
                    </tr>
                	<?php }?>
                  </tbody>
                </table>
